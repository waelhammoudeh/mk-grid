...
void printLineInfoDL (DL_LIST *list){
...
void printStringDL (DL_LIST *list){
	...
	if(DL_SIZE(list) == 0){
		printf ("printStringDL(): Empty list, nothing to do.\n");
		return;
	}
	else
		//printf("printStringDL(): List Size is: %d\n", DL_SIZE(list));
